...
class QuestionModelTests(TestCase):
    ...
    def test_can_vote_before_end_date(self):
        ...
        """
        now = timezone.now()
        future_end_date = now + datetime.timedelta(days=30)
    ...
    def test_cannot_vote_after_end_date(self):
        ...
        """
        now = timezone.now()
        past_end_date = now - datetime.timedelta(days=1)
        question = Question.objects.create(
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        self.assertRedirects(response, reverse('polls:index'))  # Ensure redirect to index
